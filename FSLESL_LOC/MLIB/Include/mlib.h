...
#define MLIB_Conv_F32L(f64Val)                                  MLIB_Conv_F32L_Ci(f64Val)
...
#define MLIB_Sat_F32A(a64Accum)                                 MLIB_Sat_F32A_Ci(a64Accum)
